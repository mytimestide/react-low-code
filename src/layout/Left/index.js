    ...
    return (
        <div className={styles.main}>
            <ul className={styles.cmps}>
                ...
                <li className={classNames(styles.cmp, showSide === isTextComponent ? styles.selected : '')}
                    onClick={() => _setShowSide(isTextComponent)}>
                    <span>文本</span>
                </li>
                <li className={classNames(styles.cmp, showSide === isImgComponent ? styles.selected : '')}
                    onClick={() => _setShowSide(isImgComponent)}>
                    <span>图片</span>
                </li>
                <li className={classNames(styles.cmp, showSide === isGraphComponent ? styles.selected : '')}
